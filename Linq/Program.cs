...
namespace Linq
{
    class Program
    {
        ...
        private static void OrderByAndSelect()
        {
            string[] cities =
                        {
                "ROME","LONDON","NAIROBI","CALIFORNIA","ZURICH","NEW DELHI","AMSTERDAM","ABU DHABI", "PARIS", "CANNAS"
        ...
        /// </summary>
        private static void FirstJoinLinq()
        {
        ...
        /// </summary>
        private static void CartesianProductThreeSets()
        {
            char[] charset1 = { 'X', 'Y', 'Z' };
            int[] numset1 = { 1, 2, 3 };
        ...
        /// </summary>
        private static void FindSrtingWithSpecificLength()
        {
        ...
        /// </summary>
        private static void FindAndRemoveChar()
        {
        ...
        /// </summary>
        private static void FindUpperCaseWords()
        {
        ...
        /// </summary>
        private static void FindNBiggestInts()
        {
        ...
        /// </summary>
        private static void FindNameWithStratWithAndEndWith()
        {
            string[] cities =
                        {
        ...
        /// </summary>
        private static void SelectConfigurationOfInt()
        {
        ...
        /// </summary>
        private static void LetterFrequency()
        {
        ...
        /// </summary>
        private static void SelectNumAndSqr()
        {
        ...
        /// </summary>
        private static void GroupByAndSelect()
        {
